...
def run_inference(model_output_dir_path, model_input_dir_path, model_weights_dir_path, crop_size,
                  use_gpu, gpu_ids, export_png, model_down_steps, extended, has_manual_seg, weights_file_name):
